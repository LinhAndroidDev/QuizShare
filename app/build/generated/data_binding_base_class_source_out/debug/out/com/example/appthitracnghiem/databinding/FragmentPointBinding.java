...
public final class FragmentPointBinding implements ViewBinding {
  ...
  private FragmentPointBinding(@NonNull NestedScrollView rootView,
      @NonNull ProgressBar progressPoint) {
  ...
  public static FragmentPointBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ProgressBar progressPoint = ViewBindings.findChildViewById(rootView, id);
      if (progressPoint == null) {
        break missingId;
      }

      return new FragmentPointBinding((NestedScrollView) rootView, progressPoint);
    }
