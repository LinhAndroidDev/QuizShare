...
public final class ActivityCreateTestBinding implements ViewBinding {
  ...
  @NonNull
  public final RelativeLayout changeIdCreateExam;

  private ActivityCreateTestBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout changeIdCreateExam) {
    this.rootView = rootView;
    this.changeIdCreateExam = changeIdCreateExam;
  }
  ...
  public static ActivityCreateTestBinding bind(@NonNull View rootView) {
    ...
    RelativeLayout changeIdCreateExam = (RelativeLayout) rootView;

    return new ActivityCreateTestBinding((RelativeLayout) rootView, changeIdCreateExam);
  }
}
