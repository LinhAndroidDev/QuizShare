...
public final class FragmentIntroLoginBinding implements ViewBinding {
  ...
  @NonNull
  public static FragmentIntroLoginBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentIntroLoginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_intro_login, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentIntroLoginBinding bind(@NonNull View rootView) {
